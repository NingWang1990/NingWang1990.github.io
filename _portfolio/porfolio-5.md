...
have already been many machine-learning models available, e.g., Gaussian approximation potentials, neural-network potentials [14, 52] and moment tensor
potentials [114]. However, for magnetic materials, the machine-learning models
are still in infancy. As a first step to develop machine-learning approaches for
...
a perturbation approach to correct the error in the thermodynamic calculations
